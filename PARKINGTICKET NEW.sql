...
exec Totalamount1 0,201,301,'HARRIER',50,4.0,'I'
exec Totalamount1 0,201,302,'FORTUNER',50,6.0,'I'
exec Totalamount1 0,202,303,'BMW',50,2.0,'I'
exec Totalamount1 0,203,304,'BENTLY',50,8.0,'I'
exec Totalamount1 0,204,305,'AUDI',50,5.0,'I'
exec Totalamount1 0,205,306,'MINI COPPER',50,1.0,'I'



delete from ParkingTicket where TicketID=305
...
select *from Totalamount
  ...
  alter TRIGGER updateAmountOnTotal
ON Totalamount
AFTER INSERT
AS
BEGIN
...
CREATE TRIGGER UpdateParkingSpaceOnExit2
ON ParkingTicket
AFTER DELETE
AS
BEGIN
